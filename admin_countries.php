        ...
        <div class="modal-dialog">
          ...
          <div class="content" style="margin: 0px;">
            <div class="modal-header">
              ...
              <div style="text-align: center;"><h2 class="modal-title">Add / Update Country</h2></div>
            </div>
            <div class="modal-body">
                <div >
                        ...
                        <div class="row">
                            <div class="form-group col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 col-sm-12 col-xs-12">
                                <b>Country name</b>
                                <input type="text" name="country_val" id="country_val" maxlength="30" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row" style="display: none;" id="prob_dsp">
                            <div class="form-group col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                                <span style="color: red; " ><b>Country name can not be Empty !!</b></span>
                            </div>
                        </div> 
                    ...
                    <?php include('inc/adminmenu.php');?> <!-- Sidebarul<ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li ><a href="admin_countries.php"><span style="color: white;">Countries</span></a></li>
                                ...
                                <div class="card-content">
                                            ...
                                            <table class="responsive-table highlight bordered table2excel" id="mytable">
                                                <thead style="background-color: #006699; color: white;">
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center; color: white;"><b>Country Name</b></th>
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $qc = mysqli_query($db, "SELECT * FROM country");
                                                        ...
                                                        while($rc = mysqli_fetch_assoc($qc)) {
                                                            echo '<tr>';
                                                                ...
                                                                echo '<td style="text-align: center;">';
                                                                $tt = my_simple_crypt($rc["country_id"], 'e');
                                                                echo '<a data-toggle="modal" data-target="#myModal1" href="#myModal1"  data-id="'.$rc["country_id"].'" </b>EDIT</a> / '.'<a href="delete_country.php?astd_id='.$tt.'">DELETE</a>';
                                                                echo '</td>';
                                                            echo '</tr>';
                                                        }
                                    ...
                                    <div class="row">
                                        <div class="col-lg-1 col-md-1 col-sm-4 col-xs-4 col-sm-offset-4 col-xs-offset-4 col-md-offset-10 col-lg-offset-10">
                                            <button class="btn  btn-info " data-toggle="modal" data-target="#myModal1"  id="add_but"><b>Add Country</b></button>
                                        </div>
    ...
    $(document).ready(function(){
        //alert("good done");
            ...
            $('a[href="#myModal1"]').click(function(){
                ...
                $('#as_id').val(t_id_tmp);
                $.ajax({
                  url: "country_details.php",
                  type: "post",
                  data: {get: "yes", id: t_id_tmp},
                  success: function(response){  
                       $('#country_val').val(response);
            ...
            $('#btn_save').click(function(){
                ...
                var country_val = $('#country_val').val();
                if(country_val == ""){
                    $("#prob_dsp").css("display", "block");
                        ...
                        $.ajax({    
                          url: "country_details.php",
                          type: "post",
                          data: {save: "yes", country_val: country_val, id: chk_val},
                          success: function(response){  
                              //alert(response);
                              /*if(response == "don"){
